...
const herramientasUtilizadas = document.getElementById('herramientasUtilizadas');
const textoProyecto1 = document.getElementById('textoProyecto1');
const buttonRepositorio = document.getElementsByClassName('buttonRepositorio');
const buttoonPaginaWEb = document.getElementById('buttoonPaginaWEb');
const repositorio1 = document.getElementById('buttonPrototipo');
...
const saludos = [saludo2, saludo3, saludo4, saludo5, saludo6, textobio1, textobio2, textobio3, idiomas, portadaTitulo, tituloBiografia, tituloProyectos, herramientasUtilizadas, textoProyecto1, buttonRepositorio, buttoonPaginaWEb, buttonPrototipo, tituloHerramientas];
